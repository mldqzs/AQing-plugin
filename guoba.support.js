    ...
    configInfo: {
      schemas: [
        ...
        },
        {
          ...
          bottomHelpMessage: '推荐直接发「#酷狗音乐扫码登录」，机器人会发送二维码并自动保存；也可手动粘贴完整 Cookie',
          component: 'Input',
        ...
        },
        {
          ...
          label: '酷狗用户 ID',
          bottomHelpMessage: '扫码登录后自动保存；手动配置时填写 Cookie 中的 KugooID',
          component: 'Input',
        ...
        },
        {
          ...
          label: '酷狗登录 Token',
          bottomHelpMessage: '扫码登录后自动保存；手动配置时填写 Cookie 中的 t',
          component: 'Input',
