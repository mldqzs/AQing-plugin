    ...
    configInfo: {
      schemas: [
        ...
        },
        {
          ...
          label: 'QQ音乐 Cookie',
          bottomHelpMessage: '从已登录 QQ音乐网页复制完整 Cookie。用于获取该账号有权播放的 VIP/会员音源',
          component: 'Input',
        ...
        },
        {
          ...
          label: '酷狗 Cookie',
          bottomHelpMessage: '从已登录酷狗音乐网页复制完整 Cookie。用于获取该账号有权限播放的音源',
          component: 'Input',
          componentProps: { placeholder: '请输入酷狗完整 Cookie' },
        },
        {
