  ...
  return {
    ...
    configInfo: {
      schemas: [
        ...
        {
          field: 'config.repeatBanGroups',
          label: '开启复读禁言的群聊',
          bottomHelpMessage: '列表中的群聊会启用复读禁言；也可在群内发送「复读禁言 开启/关闭」修改同一列表',
          component: 'GTags',
          componentProps: {
            placeholder: '请输入群号',
            allowAdd: true,
        ...
        {
          field: 'config.repeatBanThreshold',
          label: '复读警告条数',
          bottomHelpMessage: '同一内容连续复读达到此条数后先发出警告，默认 3 条',
          component: 'InputNumber',
          componentProps: { min: 2, max: 20, placeholder: '默认 3' },
        },
        {
